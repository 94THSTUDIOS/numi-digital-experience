...
const StarButton = ({ href, children, className, ...props }: StarButtonProps) => {
  const baseClasses = cn(
    "group relative px-[35px] py-[12px]",
    "text-[17px] font-medium",
    "text-white",
    "bg-[#F6636F]",
    "border-[3px] border-[#F6636F]",
    "rounded-full", // changed to full to match the Numi style
    "shadow-[0_0_0_#F6636F8c]",
    "transition-all duration-300 ease-in-out",
    "cursor-pointer inline-block text-center",
    "hover:bg-transparent hover:text-[#F6636F] hover:shadow-[0_0_25px_#F6636F8c]",
    "active:scale-95",
    className
  )
