  ...
  return (
    <div className="player-container w-full max-w-4xl mx-auto flex flex-col items-center gap-4">
      ...
      */}
      <div
        id="player-frame"
        className={`player-frame relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-[#242440] ${isFullscreen ? 'w-full h-full aspect-auto' : 'w-full aspect-[4/3] max-h-[80vh]'} transition-all duration-300 [&>canvas]:!w-full [&>canvas]:!h-full [&>canvas]:!object-cover`}
      >
        {!isStarted && (
